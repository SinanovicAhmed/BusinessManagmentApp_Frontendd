  ...
  if (disabled) {
    return (
      <button
        ...
        type={type}
        disabled
        className="text-white w-[150px] bg-blue-400 cursor-not-allowed focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none"
      >
        {name}
      </button>
    );
